...
const sections = [
  ...
  },
  {
    ...
    body: "Every Orbit atom + every shadcn primitive — Button, Badge, Card, Dialog, Sheet, Popover, Tabs, Inputs, Menus, and more. Every variant is rendered here.",
    href: "/_design/components",
  },
  {
    key: "feedback",
    title: "Feedback",
    sub: "Toasts, alerts, notifications",
    body: "Sonner toast matrix (success/info/warn/error/loading/action/promise), shadcn Alerts, and the live NotificationsPanel sheet wired to /api/mocks/notifications.",
    href: "/_design/feedback",
  },
  {
    key: "navigation",
    title: "Navigation",
    sub: "Sidebars, switchers, headers",
    body: "Orbit DesignSidebar, shadcn AppSidebar, nav-main / nav-projects / nav-documents / nav-user, team + version switchers, search form, site header.",
    href: "/_design/navigation",
  },
  {
    key: "blocks",
    title: "Blocks",
    sub: "Registry compositions",
    body: "Calendars, Charts, Login form, AppSidebar, SettingsDialog, DataTable, and the Orbit IDP dashboard. Everything pulled with bunx shadcn@latest add.",
    href: "/_design/blocks",
  },
  {
    key: "conservative",
