        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: "1.2fr 1fr" }}>
              ...
              <div className="grid gap-3" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }}>
                {colorTokens.map((t) => (
                  <div key={t.token} className="flex items-center gap-3">
                    <div className={`h-8 w-8 rounded-sm shrink-0 shadow-[inset_0_0_0_1px_var(--color-line)] ${t.swatch}`} />
          ...
          <Card>
            ...
            <CardBody className="flex flex-col gap-3">
              {typeScale.map((t) => (
                <div key={t.role} className="pb-3 shadow-[0_1px_0_var(--color-line-subtle)] last:shadow-none last:pb-0">
